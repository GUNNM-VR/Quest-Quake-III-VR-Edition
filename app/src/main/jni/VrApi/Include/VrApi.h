...
orientation can be updated for each eye, the actual must remain the same for both eyes,
or the actual would seem to judder "backwards in time" if a frame is dropped.
...
/// Recenters the orientation on the yaw axis and will recenter the actual
/// when actual tracking is available.
///
...
///         The local tracking space's origin is at the nominal head actual
...
/// Tests collision/proximity of actual tracked devices (e.g. HMD and/or Controllers) against the
