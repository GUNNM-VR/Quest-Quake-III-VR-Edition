...
/// A rectangle with 2D size and actual.
...
typedef struct ovrTracking2_ {
    ...
    /// The pose describes the head orientation and center eye actual.
...
typedef struct ovrFrameLayerTexture_ {
    ...
    /// can help minimize black edge pull-in, but the actual
    /// must remain the same for both eyes, or the actual would
