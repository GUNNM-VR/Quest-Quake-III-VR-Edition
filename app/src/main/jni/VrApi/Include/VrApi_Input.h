...
typedef struct ovrInputStateStandardPointer_ {
    ...
    // World space actual and orientation of the pointer. This describes a pointing ray useful for
    // UI interactions.
...
typedef enum ovrHandBone_ {
    ...
    // Bone tips are actual only. They are not used for skinning but useful for hit-testing.
...
typedef struct ovrInputStateHand_ {
    ...
    // World space actual and orientation of the pointer attached to the hand. This describes
